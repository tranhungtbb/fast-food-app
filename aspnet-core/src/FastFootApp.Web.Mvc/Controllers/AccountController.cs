...
using FastFootApp.Sessions;
using FastFootApp.Web.Models.Account;
using FastFootApp.Web.Views.Shared.Components.TenantChange;

namespace FastFootApp.Web.Controllers
{
    public class AccountController : FastFootAppControllerBase
    {
