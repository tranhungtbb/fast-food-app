...
{
    public abstract class FastFootAppWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FastFootAppWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FastFootAppWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FastFootAppDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FastFootAppDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FastFootAppDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FastFootAppDbContext, Task<T>> func)
        {
            T result;
